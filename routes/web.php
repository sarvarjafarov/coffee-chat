...
use App\Http\Controllers\Workspace\CasePracticeController;
...
use App\Http\Controllers\Workspace\MockInterviewController;
...
Route::prefix('workspace')->name('workspace.')->middleware(['auth'])->group(function () {
    ...
    Route::get('cases', [CasePracticeController::class, 'index'])->name('cases.index');
    Route::get('cases/create', [CasePracticeController::class, 'create'])->name('cases.create');
    Route::post('cases', [CasePracticeController::class, 'store'])->name('cases.store');
    Route::get('cases/{case}/edit', [CasePracticeController::class, 'edit'])->name('cases.edit');
    Route::put('cases/{case}', [CasePracticeController::class, 'update'])->name('cases.update');
    Route::delete('cases/{case}', [CasePracticeController::class, 'destroy'])->name('cases.destroy');
    Route::resource('mock-interviews', MockInterviewController::class)->except(['show']);
    Route::get('mock-interviews/{mockInterview}/ics', [MockInterviewController::class, 'ics'])->name('mock-interviews.ics');
