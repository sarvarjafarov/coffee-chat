...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('coffeechat-os-favicon.png?v=4') }}">
        <link rel="icon" type="image/svg+xml" sizes="any" href="{{ asset('favicon.svg?v=4') }}">
        <link rel="icon" type="image/x-icon" href="{{ asset('favicon.ico?v=4') }}">
        <link rel="shortcut icon" href="{{ asset('coffeechat-os-favicon.png?v=4') }}">
        <link rel="apple-touch-icon" href="{{ asset('coffeechat-os-favicon.png?v=4') }}">
